...
$.lang.register('rafflesystem.results', 'Eine Verlosung ist bereits im Gange! Schlüsselwort: $1 - Teilnehmer:innen: $2');
...
$.lang.register('rafflesystem.subbonus.set', 'Abonnent:innen Bonusglück auf $1 festgelegt!');
$.lang.register('rafflesystem.regbonus.usage', 'Verwendung: !raffle regularbonus [1-10]');
$.lang.register('rafflesystem.regbonus.set', 'Stammzuschauer:innen Bonusglück auf $1 festgelegt!');
$.lang.register('rafflesystem.whisper.winner.toggle', 'Verlosungsgewinner:innen werden $1 angeflüstert.');
$.lang.register('rafflesystem.raffle.repick.toggle1', 'Verlosungsgewinner:innen werden nicht mehr länger neu ausgelost.');
$.lang.register('rafflesystem.raffle.repick.toggle2', 'Verlosungsgewinner:innen können nun wieder erneut ausgelost werden.');
...
$.lang.register('rafflesystem.winner.404', 'Kann keine:n Gewinner:in ermitteln. Niemand hat bei der Verlosung teilgenommen.');
