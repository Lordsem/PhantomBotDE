...
(function () {
    var subMessage = $.getSetIniDbString('subscribeHandler', 'subscribeMessage', '(name) hat abonniert!'),
            ...
            massGiftSubMessage = $.getSetIniDbString('subscribeHandler', 'massGiftSubMessage', '(name) hat gerade (amount) Abo\'s für zufällige Benutzer verschenkt!'),
            massAnonGiftSubMessage = $.getSetIniDbString('subscribeHandler', 'massAnonGiftSubMessage', 'Ein anonymer Zuschauer hat (amount) Abo\'s für zufällige Benutzer verschenkt!'),
