                        ...
                        'id': 'accordion'
                            ...
                            .append(helpers.getCollapsibleAccordion('main-5', 'Einstellungen des Alarmkanals', $('<form/>', {
                                'role': 'form'
                                    ...
                                    // Add channel box.
                                    .append(helpers.getInputGroup('channel-alert', 'Alarmkanal', '#alerts', e.subChannel,
        ...
        socket.getDBValues('alerts_get_clip_settings', {
            ...
            helpers.getModal('clip-alert', 'Clip-Alarmeinstellungen', 'Speichern', $('<form/>', {
                'role': 'form'
                    ...
                    .append(getChannelSelector('clip-channel', 'Alarm Kanal', '#alerts', e.clipsChannel,
                        ...
                        'id': 'accordion'
                            ...
                            .append(helpers.getCollapsibleAccordion('main-4', 'Alarmkanal-Einstellungen', $('<form/>', {
                                'role': 'form'
                                    ...
                                    // Add channel box.
                                    .append(getChannelSelector('channel-alert', 'Alarm Kanal', '#alerts', e.onlineChannel,
                        ...
                        'id': 'accordion'
                            ...
                            .append(helpers.getCollapsibleAccordion('main-1', 'Beitrittseinstellungen', $('<form/>', {
                                'role': 'form'
                                    ...
                                    .append(helpers.getTextAreaGroup('join-message', 'text', 'v', '', e.joinMessage,
                            ...
                            .append(helpers.getCollapsibleAccordion('main-3', 'Alarmkanal-Einstellungen', $('<form/>', {
                                'role': 'form'
                                    ...
                                    // Add channel box.
                                    .append(getChannelSelector('channel-alert', 'Alarmkanal', '#alerts', e.greetingsChannel,
